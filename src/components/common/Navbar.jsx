  ...
  return (
    ...
    >
      <div className="container-bound flex items-center justify-between gap-4">
        <Link to="/" className="group flex items-center gap-3 min-[320px]:max-[390px]:gap-[8px]">
          ...
          <div className="leading-none">
            ...
            <span className="mt-1 block text-[10px] font-semibold uppercase tracking-[0.34em] text-slate-500 dark:text-slate-400 min-[320px]:max-[430px]:text-[8px]">Premium Athletic Goods</span>
          </div>
        </Link>
